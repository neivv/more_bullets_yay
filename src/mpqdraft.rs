...
struct Vtable {
    ...
    Configure: unsafe extern "stdcall" fn(*mut MpqdraftPlugin, usize) -> u32,
...
unsafe extern "stdcall" fn get_plugin_name(_plugin: *mut MpqdraftPlugin, out: *mut u8, out_size: u32) -> u32 {
    ...
    let result = write!(out, "A small limit plugin {}", env!("CARGO_PKG_VERSION"));
...
unsafe extern "stdcall" fn configure(_plugin: *mut MpqdraftPlugin, _hwnd: usize) -> u32 {
    1
}
